...
func JSONtoRawdata(t AutoGenerated, rawdata *test.RawData) {
	...
	var str *string
	itest := "0a2e0511-f640-418b-bbf4-a0d83cd8a2a8"
...
func SendRawdataToNudge() {
	...
	file, _ := os.Open("collecte_2021-07-05_13-51-27-449_99.dat") // changer le nom du file ?

	defer file.Close()

	r, _ := http.NewRequest("PUT", "http://172.17.0.4:8080/collect/rawdata/0a2e0511-f640-418b-bbf4-a0d83cd8a2a8", file)
...
// Fonction qui prend la donnée de temps du JSON et la convertit en un pointeur int64
func TimeToInt64(v string) *int64 {
	...
	var StartTimePointer *int64 = &TimeInt64
